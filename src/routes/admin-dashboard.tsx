...
import { AdminDashboardPageContent } from "@/components/RolePages";
...
export const Route = createFileRoute("/admin-dashboard")({
  ...
  },  head: () => ({ meta: [{ title: "Admin Dashboard - Renstra Monitoring" }] }),
...
function AdminDashboard() {
  ...
  if (isLoading || !isAdmin) {
    return <LoadingShell title="Memuat Admin..." />;
  }

  return (
    <AppShell
      title="Dashboard Admin"
      subtitle="Ringkasan progres dan monitoring capaian"
      actions={
    ...
    >
      <div id="report-content">
        <AdminDashboardPageContent programs={programs} />
      </div>
    </AppShell>
  );
}
